  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
        ...
        <div class="sidebar-brand-text mx-3">Saladman Admin</div>
      </a>
      ...
      <!-- <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="index.php?halaman=produk">List</a>
          </div>
        </div>
      </li> -->
      ...
      <!-- <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Menu:</h6>
            <a class="collapse-item" href="index.php?halaman=pembelian">Data</a>
            <a class="collapse-item" href="index.php?halaman=laporan-pembelian">Laporan</a>
          </div>
        </div>
      </li> -->
      ...
      <li class="nav-item">
        <a class="nav-link" href="index.php?halaman=laporan-pembelian">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
            <div class="input-group">
              <input type="text" class="form-control bg-light border-0 small" placeholder="Maaf, untuk sementara fitur pencarian tidak berfungsi..." aria-label="Search" aria-describedby="basic-addon2">
          ...
          <div class="row">
            <?php 
                if(isset($_GET['halaman'])){
                    ...
                    elseif($_GET['halaman']=='tambah-kategori'){
                        include 'tambah-kategori.php';
                    }
                    elseif($_GET['halaman']=='ubah-kategori'){
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy; Kebun Mimba 2020</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
